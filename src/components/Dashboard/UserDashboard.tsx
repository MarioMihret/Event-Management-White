...
const UserDashboard = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      description: 'Learn the latest design trends and tools in this interactive virtual workshop.',
      date: 'Mar 20, 2024',
      meetingLink: 'https://meet.jit.si/event-abc123',
      attendees: 45,
      maxAttendees: 100,
      price: 99,
      image: 'https://images.unsplash.com/photo-1511795409834-432e51f83099?auto=format&fit=crop&q=80'
    }
  ];
